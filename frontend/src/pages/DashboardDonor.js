...
export function renderDashboardDonor() {
  ...
  return `
    <div style="animation: fadeInUp 0.4s ease;">
      ...
      <!-- Donor Passport + 3D DNA Canvas + QR Badge -->
      <div style="display:grid; grid-template-columns: 6fr 3fr 3fr; gap:1.5rem; margin-bottom:2rem;">

        <!-- Donor Pass Card -->
        <div class="problem-card green" style="margin:0;">
          <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.5rem;">
            <h3 style="color:#42be65; margin:0; font-size:15px; font-weight:700;"><i class="fa-solid fa-id-card"></i> Official Pledged Organ Donor Pass</h3>
          ...
          <div style="display:flex; flex-direction:column; gap:12px; font-size:13px;">
            ...
            <div style="display:flex; justify-content:space-between; border-bottom:1px solid #393939; padding-bottom:8px;">
              ...
              <span class="ticker-badge badge-critical">O POSITIVE (O+)</span>
            </div>
            <div style="display:flex; justify-content:space-between; border-bottom:1px solid #393939; padding-bottom:8px;">
            ...
            <div style="display:flex; justify-content:space-between; border-bottom:1px solid #393939; padding-bottom:8px;">
              <span style="color:#8d8d8d;">PLEDGED ORGANS</span>
              <span style="color:#42be65; font-weight:600;">Heart, Kidney, Cornea, Liver</span>
            </div>
            <div style="display:flex; justify-content:space-between;">
              <span style="color:#8d8d8d;">QUANTUM ALLOCATION STATUS</span>
        ...
        <!-- 3D DNA Canvas Card -->
        <div class="problem-card blue" style="margin:0; padding:1.25rem; text-align:center; display:flex; flex-direction:column; justify-content:space-between;">
      ...
      <div class="problem-card blue" style="margin:0; padding:2rem;">
        <div style="display:flex; align-items:center; gap:12px; margin-bottom:1.25rem;">
          ...
          <div>
            <h3 style="font-size:15px; font-weight:700; color:#f4f4f4; margin:0;">Register Organ Availability into Quantum Network</h3>
            <p style="font-size:12px; color:#8d8d8d; margin:2px 0 0 0;">Submitting triggers Grover's Quantum algorithm to find the ideal matched patient in seconds.</p>
          </div>
        </div>
        ...
        <form id="form-donor-register-organ">
          <div class="organ-form-grid" style="margin-bottom:1rem;">
            ...
            <div class="form-group">
              <label>HLA Antigen Markers</label>
              <input type="text" id="donor-hla-type" value="A2,B7,DR4" required />
            </div>
            <div class="form-group">
              <label>Max Cold Ischemia Hours</label>
